...
const CONFIG = {
  ...
  initialZoom: 9.3,
  layerColors: {
    "Attractions": "#d73027",      // 红
    "Museums": "#67001f",         // 深红
    "Galleries": "#081d58",       // 深蓝
    "Parks_&_Gardens": "#41b6c4", // 浅蓝
    "Historic_Sites": "#225ea8"   // 蓝
  },
  layerFiles: {
...
async function initApp() {
  ...
  // 添加新部分的初始化
  const newSectionManager = new NewSectionManager(mapManager);
  newSectionManager.initialize();
}
